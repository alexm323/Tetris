document.addEventListener('DOMContentLoaded', () => {
	...
	//move the tetrominoe to the left , unless is at the edge or there is a blockage
	function moveLeft() {
		undraw();
	...
	function rotate() {
		...
		if (currentRotation === current.length) {
			// if the current toation gets to 4 , make it go back to 0
			currentRotation = 0;
		}
		current = theTetrominoes[random][currentRotation];
		draw();
	...
	// the tetromnios without rotations
